...
const ProductDetail=({form,list_choice,data_item,list_buymore,shipping_shop,setshow,
    ...
    },[form,data_item,list_buymore,shipping_shop,shipping_item,listmedia])
    ...
    const filepreview=(i,media,name,value,filetype)=>{
        ...
        return(
            <div className="image-manager__item cover-item">
                ...
                {name=='list_image' && (<p className="explain-text">{name=='list_color'?media.value:media.filetype=='video'?'Video':i==0?'Image cover':`Image${i}`}</p>)}
            </div>
        )
    }
    ...
    const removemedia=(i,media,name,value)=>{
        const list_medias=value.map((item,index)=>{
            if(i==index){
                                                    ...
                                                    <div  className="variation-model-table">
                                                        <ContentLeft>
                                                            ...
                                                            <Bodytable>
                                                                ...
                                                                <div key={i} data-v-4d4bd544="" className={`flex`}>
