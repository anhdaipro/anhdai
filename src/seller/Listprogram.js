...
import {listdiscountshopURL,formatter,timepromotion} from "../constants"
...
const Listdiscountshop=()=>{
    ...
    useEffect(()=>{
        axios.get(listdiscountshopURL,headers)
        .then(res=>{
                                            ...
                                            <div data-v-439649ed="" className="popover popover--light">
                                                ...
                                                <div className="popper popover__popper popover__popper--light with-arrow" style={{display: 'none', maxWidth: '320px'}}>
                                                    <div className="popover__content">
                                                        <div data-v-439649ed="">Tổng giá trị của các đơn hàng có áp dụng discount Của Shop đã được xác nhận, bao gồm phí vận chuyển và không bao gồm các khuyến mãi khác, tính trong khoảng thời gian đã chọn.</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
                            ...
                            <div className="card__content">
                                ...
                                <div data-v-439649ed="" className="landing-page-content aguth_iEwtiEw1ejuP3Yg">
                                            ...
                                            <div data-v-40673d96="" className="custom-input-group">
                                                <div data-v-40673d96="" className="search-label">Thời gian khuyến mãi
                                                    <div data-v-40673d96="" className="action-btns">
                                                        <button data-v-40673d96="" type="button" className="button btn-orange button--normal">
                                                            <span>Tìm</span>
                                                        </button> 
                                    ...
                                    <div data-v-771d39f6="" className="landing-page-filter-hints">
                                        Có tất cả <em data-v-771d39f6="" place="count">8</em> discount Khuyến Mãi
                                    </div>
                                                                ...
                                                                <div className="scrollbar__content">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr className="table__row valign-top landing-row">
                                                                            ...
                                                                            <td className="">
                                                                                <div className="table__cell">
                                                                                    <div data-v-6b00c90e="" className={`tag tag__information tag--normal ${new Date()>new Date(discount.valid_to)?'invalid':new Date()< new Date(discount.valid_from)?'default':''}`}>{new Date()>new Date(discount.valid_to)?'Đã kết thúc':new Date()< new Date(discount.valid_from)?'Sắp diễn ra':'Đang diễn ra'}</div> 
                                                                                </div>
                                                                            </td>
