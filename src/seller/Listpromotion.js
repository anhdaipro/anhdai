...
const Listcomboshop=()=>{
    ...
    useEffect(()=>{
        axios.get(listcomboshopURL,headers)
        .then(res=>{
            setCombo(res.data)
        })
    },[])
    ...
    return(
        <>
                ...
                <div data-v-6b00c90e="" data-v-4d2c3cc3="" className="bundle-list-page"> 
                    <div data-v-2069d7ac className="wrapper">
                                            ...
                                            <div data-v-439649ed="" className="popover popover--light">
                                                ...
                                                <div className="popper popover__popper popover__popper--light with-arrow" style={{display: 'none', maxWidth: '320px'}}>
                                                    <div className="popover__content">
                                                        <div data-v-439649ed="">Tổng giá trị của các đơn hàng có áp dụng combo Của Shop đã được xác nhận, bao gồm phí vận chuyển và không bao gồm các khuyến mãi khác, tính trong khoảng thời gian đã chọn.</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
                            ...
                            <div className="card__content">
                                ...
                                <div data-v-439649ed="" className="landing-page-content aguth_iEwtiEw1ejuP3Yg">
                                    ...
                                    <div data-v-771d39f6="" className="landing-page-filter-hints">
                                        Có tất cả <em data-v-771d39f6="" place="count">8</em> Combo Khuyến Mãi
                                    </div>
                                                                ...
                                                                <div className="scrollbar__content">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr className="table__row valign-top landing-row">
                                                                            ...
                                                                            <td className="">
                                                                                <div className="table__cell">
                                                                                <div data-v-6b00c90e="" className={`tag tag__information tag--normal ${new Date()>new Date(combo.valid_to)?'invalid':new Date()< new Date(combo.valid_from)?'default':''}`}>{new Date()>new Date(combo.valid_to)?'Đã kết thúc':new Date()< new Date(combo.valid_from)?'Sắp diễn ra':'Đang diễn ra'}</div> 
                                                                                </div>
                                                                            </td>
