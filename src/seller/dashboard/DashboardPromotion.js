...
const DashboardPromotion=()=>{
    ...
    {name:'Số lượng combo đã bán',id:5,info:'Tổng số lượng Combo Khuyến Mãi đã bán tính trên toàn bộ các đơn hàng được xác nhận, tính trong khoảng thời gian đã chọn.',result:0,result_last:0},
    {name:'Doanh số trên mỗi Người mua',id:6,info:'Giá trị trung bình của các đơn đặt hàng đã xác nhận với các mặt hàng trong Combo khuyến mãi cho mỗi người mua, bao gồm phí vận chuyển và không bao gồm các khuyến mãi khác, trong khoảng thời gian đã chọn.',result:0,result_last:0}])
