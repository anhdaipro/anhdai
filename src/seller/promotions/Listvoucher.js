                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr key={voucher.id} className="table__row valign-top landing-row">
                                                                    ...
                                                                    <td className=""><div className="table__cell">
                                                                        <div data-v-6b00c90e="" className={`tag tag__information tag--normal ${new Date()>new Date(voucher.valid_to)?'invalid':new Date()< new Date(voucher.valid_from)?'default':'success'}`}>{new Date()>new Date(voucher.valid_to)?'Đã kết thúc':new Date()< new Date(voucher.valid_from)?'Sắp diễn ra':'Đang diễn ra'}</div> 
