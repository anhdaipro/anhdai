                                ...
                                <div className="header-section__header">
                                    ...
                                    <a className="header-section__header-link" tabindex="-1" href="/search_user?keyword=yyy">
                                        <button className="button-no-outline">
                                            Thêm kết quả&nbsp;<svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" className="svg-icon icon-arrow-right"><path d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z"></path></svg>
                                        </button>
                                    </a>
                                </div>
                                    ...
                                    <div className="search-user-item search-user-item--short">
                                        ...
                                        <div className="search-user-item__statistics">
                                            <div className="search-user-seller-info-item">
                                                <div className="search-user-seller-info-item__wrapper">
                                                    <div className="search-user-seller-info-item__header">
                                                        <svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0" className="svg-icon icon-products"><g><path d="m10 1 4.5 2.5-.5 3h-2v7.5h-9v-7.5h-2l-.5-3 4.6-2.5c.3 1.1 1.3 1.9 2.4 1.9s2.1-.8 2.5-1.9z" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"></path><line fill="none" stroke-linecap="round" stroke-miterlimit="10" x1="3" x2="12" y1="11.5" y2="11.5"></line></g></svg>
                                            ...
                                            <div className="search-user-seller-info-item">
                                                <div className="search-user-seller-info-item__wrapper">
                                                    <div className="search-user-seller-info-item__header">
                                                        <svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0" className="svg-icon "><g><polyline fill="none" points="7.2 3.5 7.2 7.8 10.5 7.8" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"></polyline><circle cx="7.5" cy="7.5" fill="none" r="6.5" stroke-miterlimit="10"></circle></g></svg>
