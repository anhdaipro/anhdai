                                        ...
                                        <div key={i} onClick={(e)=>{
                                            ...
                                            <div className="action-thread">
                                                <div className="chat-messsage-time-last">
                                                    {thread.message_last?<>{checkDay(new Date(thread.message_last.createad))=="Today"?`${("0" + new Date(thread.message_last.createad).getHours()).slice(-2)}:${("0" + new Date(thread.message_last.date_createad).getMinutes()).slice(-2)}`:checkDay(new Date(thread.message_last.createad))=="Yesterday"?`Yesterday, ${("0" + new Date(thread.message_last.createad).getHours()).slice(-2)}:${("0" + new Date(thread.message_last.createad).getMinutes()).slice(-2)}`:new Date(thread.message_last.createad).getFullYear()<new Date().getFullYear()?`${("0" + new Date(thread.message_last.createad).getDate()).slice(-2)} Tháng ${("0"+(new Date(thread.message_last.createad).getMonth()+1)).slice(-2)}, ${new Date(thread.message_last.createad).getFullYear()}`:`${("0" + new Date(thread.message_last.createad).getDate()).slice(-2)} Tháng ${(new Date(thread.message_last.createad).getMonth()+1)} lúc ${("0" + new Date(thread.message_last.createad).getHours()).slice(-2)}:${("0" + new Date(thread.message_last.createad).getMinutes()).slice(-2)}`}</>:''}
                                                </div>
