                ...
                <div key={item.item_id} className="grid__column-2-4">
                    ...
                    <div className="home-product-item-info">
                        ...
                        <div className="_3_FVSo">  
                            {item.count_program_valid>0?
                            <>
                            <div className="home-product-item__price-old zp9xm9">₫{formatter.format((item.item_max+item.item_min)/2)}</div>
                            <div className="home-product-item__price-current">
                            <span className="_1y2DMk">₫</span><span className="_3c5u7X">{formatter.format((item.item_max+item.item_min)/2*(1-item.percent_discount/100))}</span>
                            </div>
                            </>:
                            <div className="home-product-item__price _3c5u7X">₫{formatter.format((item.item_max+item.item_min)/2)}</div>}
                        ...
                        {item.percent_discount>0 && item.count_program_valid>0?
