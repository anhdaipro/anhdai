...
const Datepicker=(props)=>{
    const {item,index,onChange,settimeschoice,scrooltimes,comfirmdate,showon}=props
        ...
        <div ref={parent} className="rele">
            ...
            <div className="date_pickers popper_content" style={{display:`${show?'':'none'}`}}>
                ...
                <div className="date-picker-panel__footer">
                    <button onClick={()=>{comfirmdate(index)
                    setShow(false)
        ...
        <div>
            <div className="form-item_control">
                {date.map((item,index)=>
                    ...
                    settimeschoice={(e,item,value,name)=>settimeschoice(e,item,value,name)}
                    scrooltimes={(e,item,name,value)=>scrooltimes(e,item,name,value)}
                    comfirmdate={(index)=>comfirmdate(index)}
                    />  
                )}     
            </div>
