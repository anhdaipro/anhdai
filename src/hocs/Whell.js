    ...
    return (
        ...
        <div className="item-center">
            <div class="rule">
                ...
                <div key={index} class="rule__content">
            ...
            <div class="wheeldotsround">
                ...
                <div class="wheel__inner" style={{transform: `rotate(${rotate}deg)`}}>
                
                    {listaward.map((item,i)=>
                    <div key={item.to} class="wheel__sec">
                        {i==5?
                ...
                <div class="wheel__arrow">
                    ...
                    }} class="wheel__button">QUAY</button>
                </div>
            </div>
            <div class="congratulation" style={{display: `${show?'block':''}`}}>
                <div class="congratulation__container">
                    <div onClick={e=>setShow(false)} class="congratulation__close">
                    <i class="close-btn icon"><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="congratulation__note">{itemchoice?itemchoice.name:null}</p>
                </div>
            </div>
        </div>
       
        <div class="Event___StyledDiv-sc-2xszun-0 giheuQ pc" style={{backgroundColor: `rgb(242, 103, 48)`, backgroundImage: `url(https://cf.shopee.vn/file/d27d25139624029a1b42986c51768d14)`, color: `rgb(15, 50, 104)`}}>
            <div class="Event___StyledLuckydraw-sc-2xszun-1 fWOLQT draw-wrapper" style={{marginTop: `210.756px`}}>
                <div class="style__DivOuterContainer-sc-1is5xc9-0 eKqPLM">
                    <div class="Wheel___StyledDiv-sc-1busdjs-0 eSllRk stop">
                        <div class="Wheel___StyledDiv2-sc-1busdjs-1 eOzsHg" style={{transform: `rotate(${rotate}deg)`,transition: `cubic-bezier(0.19, 1, 0.22, 1) 5s`}}>
                            <div class="style__DivWheel-sc-1is5xc9-1 fKFjrd">
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 hhmdQG">
                                </div>
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 iOhrcT">
                                </div>
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 XJVYL">
                                <div className="p-1_2">fuanr</div>
                                </div>
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 gDTFHd">
                                </div>
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 fHQoVh">
                                </div>
                                <div class="style__DivPrizeItem-sc-1is5xc9-2 FmieL">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="style__DivPointer-sc-1is5xc9-3 kEYTju">
                    </div>
                    <div class="style__DivButtonBorder-sc-1is5xc9-4 kInvFH">
                    </div>
                    <button onClick={()=>{
                        if(time==0){
                        setwhell()
                        }
                    }} type="button" class="style__Button-sc-1is5xc9-5 JYLda"></button>
                </div>
            </div>
            <div class="style__DivListContainer-sc-1kiu30y-0 jgCaNO">
                <div class="style__DivListTitleWrapper-sc-1kiu30y-2 eieSEM">
                    <div class="style__DivListTitle-sc-1kiu30y-3 dBwGxJ">Giải thưởng</div>
                </div>
                <div class="style__DivListWrapper-sc-1kiu30y-1 dRjCzA">
                    <div class="style__DivListItemWrapper-sc-1kiu30y-4 guAPKv">
                        <div class="list___StyledDiv-sc-1kye8t0-0 imqnpO">
                            <div class="style__DivListItemIconWrapper-sc-1kiu30y-5 llvLmw">
                                <img src=""/>
                            </div>
                            <div class="style__DivListItemContent-sc-1kiu30y-7 QEHWP">Giảm giá 3% , cho đơn từ ₫20.000</div>
                        </div>
                        <div class="list___StyledDiv-sc-1kye8t0-0 imqnpO">
                            <div class="style__DivListItemIconWrapper-sc-1kiu30y-5 llvLmw">
                                <img src=""/>
                            </div>
                            <div class="style__DivListItemContent-sc-1kiu30y-7 QEHWP">Giảm giá 4% , cho đơn từ ₫20.000</div>
                        </div>
                        <div class="list___StyledDiv-sc-1kye8t0-0 imqnpO">
                            <div class="style__DivListItemIconWrapper-sc-1kiu30y-5 llvLmw">
                                <img src=""/>
                            </div>
                            <div class="style__DivListItemContent-sc-1kiu30y-7 QEHWP">Giảm giá 3% , cho đơn từ ₫15.000</div>
                        </div>
                        <div class="list___StyledDiv-sc-1kye8t0-0 imqnpO">
                            <div class="style__DivListItemIconWrapper-sc-1kiu30y-5 llvLmw">
                                <img src=""/>
                        ...
                        <div class="list___StyledDiv-sc-1kye8t0-0 imqnpO">
                            ...
                            <div class="style__DivListItemContent-sc-1kiu30y-7 QEHWP">Giảm giá 4% , cho đơn từ ₫3.000</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="chanceInfo___StyledDiv3-sc-15uhzom-2 hvFjmw" style={{visibility: `visible`}}>
                <div color="rgba(15, 50, 104, 1)" class="style__divChanceLeft-vmqj2w-0 bfRbJb">Bạn còn 4 lượt chơi</div>
            </div>
            <div class="style__divOuterWrapper-bs7ixc-0 bzIvKm">
                <div class="style__divContainer-bs7ixc-1 kpnMHw bg">
                    <p class="shareInfo___StyledP-sc-1uw305o-0 eytuCY">Nhận thêm lượt chơi lúc</p>
                    <div class="style__divBtnContainer-bs7ixc-2 apugu">
                        <div class="style__divBtnWrapper-bs7ixc-3 iIkGxu">
                            <button color="rgba(15, 50, 104, 1)" class="style__buttonShare-bs7ixc-4 jzLfrD">
                                <span class="style__spanIconWrapper-bs7ixc-5 gGuIca">
                                ...
                                <span class="style__spanText-bs7ixc-6 iBdkuH">Chia sẻ để nhận lượt chơi</span>
                            </button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="style__DivListContainer-jcpc72-0 iMxOhJ empty-list">
                <div class="style__DivListScroll-jcpc72-1 kFSpyK" style={{transform: `translateY(20px)`}}>
                </div>
            </div>
            <div class="rule___StyledDiv-sc-12mouf4-0 fVlPrn">
                <h2 class="rule___StyledH-sc-12mouf4-1 gEqsnv">- 
                    <span class="rule___StyledSpan-sc-12mouf4-2 cVNQIu">Mô tả trò chơi</span> -
                </h2>
                <div class="rule___StyledDiv2-sc-12mouf4-3 pxbqb">Bấm “QUAY” để bắt đầu quay vòng quay. Ô giải thưởng nào dừng lại ở vị trí mũi tên khi vòng quay kết thúc bạn sẽ nhận được quà của ô giải thưởng đó.</div>
            </div>
            <div class="rule___StyledDiv-sc-12mouf4-0 fVlPrn">
                <h2 class="rule___StyledH-sc-12mouf4-1 gEqsnv">- 
                    <span class="rule___StyledSpan-sc-12mouf4-2 cVNQIu">Thể lệ trò chơi</span> -
                </h2>
                <div class="rule___StyledDiv2-sc-12mouf4-3 pxbqb">
                ...
                <div class="shopInfo___StyledDiv-sc-1kbe848-0 hHQDel">
                    <div color="rgba(15, 50, 104, 1)" class="style__divContainer-sc-1ly2gru-0 eaoPfD">
                        <img src="https://cf.shopee.vn/file/e09b7eec5fbf3add1ed6287059ad87cd_tn" class="shopInfo___StyledImg-sc-1kbe848-1 icWoHp"/>
                        <p class="style__pShopName-sc-1ly2gru-1 kvGvgi">anhdai123456</p>
                    </div>
                </div>
            </div>
        </div>
