        ...
        <div className='popup modal__transition-enter-done'>
            ...
            <div className="popup__container">
                ...
                <div className="_1rm71c">
                    <svg width="54" height="54" viewBox="0 0 54 54" fill="none" className="_1SGlmP"><path fillRule="evenodd" clipRule="evenodd" d="M27 53C41.3594 53 53 41.3594 53 27C53 12.6406 41.3594 1 27 1C12.6406 1 1 12.6406 1 27C1 41.3594 12.6406 53 27 53Z" stroke="#66CC00" strokeWidth="2"></path><path fillRule="evenodd" clipRule="evenodd" d="M26.7985 36.098L40.3628 22.263C41.273 21.3528 41.1992 19.8032 40.198 18.802C39.1968 17.8008 37.6472 17.727 36.737 18.6372L24.7717 30.8413L17.263 24.0774C16.3528 23.1672 14.8032 23.241 13.802 24.2422C12.8008 25.2435 12.727 26.7931 13.6372 27.7033L23.2458 36.3588C24.156 37.269 25.7056 37.1952 26.7069 36.194C26.7383 36.1625 26.7689 36.1305 26.7985 36.098Z" fill="#66CC00"></path></svg>
