...
const Daterange=(props)=>{
    const {setDaychoice,daychoice}=props
        ...
        <div ref={parent} data-v-40673d96="" className="date-picker search-time">
            <div className="date-picker__input">
                <div onClick={(e)=>{
                    ...
                    <div className="selector__inner placeholder line-clamp--1">{daychoice.start && daychoice.end?`${timeformat(daychoice.start)} - ${timeformat(daychoice.end)}`:'Bắt Đầu - Kết Thúc'}</div> 
