                            ...
                            <div className="_1rcMMD">
                                <div className="_3odSz_">
                                    <div className="_1pKQJd">
                                        <svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" className="svg-icon icon-arrow-left"><g><path d="m8.5 11c-.1 0-.2 0-.3-.1l-6-5c-.1-.1-.2-.3-.2-.4s.1-.3.2-.4l6-5c .2-.2.5-.1.7.1s.1.5-.1.7l-5.5 4.6 5.5 4.6c.2.2.2.5.1.7-.1.1-.3.2-.4.2z"></path></g></svg>
                                        <span>TRỞ LẠI</span>
                                    </div>
                                    <div>
                                        ...
                                        <div className="item-center">
                                            <div className="item-center WqnWb-">
                                                <div className="item-center">
                                                    ...
                                                    <Link className="_2L5VLu" to="undefined">
                                            ...
                                            {data.order_item.map(orderitem=>
                                            <div className="_1limL3">
                                                <div>
                                                    <Link className="_1BJEKe" to={orderitem.item_url}><div>
                                                        </div>
                                                            ...
                                                            <div className="_1cxKtp">
                                                                <div>
                                                                    <div className="_1xHDVY">
                                                                        <span className="_30COVM">{data.order_item.item_name}</span>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                        ...
                                                        <div className="_1kvNGb">
                                                            <div>
                                                                <span className="_34DOjq">₫{formatter.format(orderitem.price)}</span>
                                                                <span className="mBERmM _2mEJ4q">₫{formatter.format(orderitem.total_price)}</span>
                                                            </div>
                                                        </div>
                                                    </Link>
                                                </div>
