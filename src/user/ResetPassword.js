                            ...
                            <div className="_3e4zDA _2kpMlA">
                                ...
                                <div className="h4yPIu">
                                    ...
                                    <div className={`_3ZGVRW ${formData.password==null?'_2VbYfm':formData.password.search(/[a-z]/) < 0?'_1ilZVp':'_32YsrV'}`}>
                                        ...
                                        {formData.password==null?'':formData.password.search(/[a-z]/) >= 0?<svg fill="none" viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#6C0" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M11.621 6.406l-3.98 4.059c-.266.266-.719.244-1.012-.049-.293-.293-.314-.746-.048-1.012l3.98-4.059c.266-.266.719-.245 1.012.048.293.293.314.747.048 1.013z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M3.803 7.997l2.81 2.532c.267.267.72.245 1.013-.048.293-.293.315-.746.048-1.012l-2.81-2.532c-.267-.267-.72-.245-1.013.048-.293.293-.314.746-.048 1.012z" clip-rule="evenodd"></path></svg>:<svg viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#FF424F" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><rect stroke="none" width="7" height="1.5" x="6.061" y="5" fill="#FF424F" rx=".75" transform="rotate(45 6.06 5)"></rect><rect stroke="none" width="7" height="1.5" fill="#FF424F" rx=".75" transform="scale(-1 1) rotate(45 -11.01 -9.51)"></rect></svg>}
                                    </div>
                                    <div className={`_3ZGVRW  ${formData.password==null?'_2VbYfm':formData.password.search(/[A-Z]/) < 0?'_1ilZVp':'_32YsrV'}`}>
                                    ...
                                    <div className={`_3ZGVRW  ${formData.password==null?'_2VbYfm':formData.password.length<=16 && formData.password.length>=6?'_32YsrV':'_1ilZVp'}`}>
                                        ...
                                        {formData.password==null?'':formData.password.length<=16 && formData.password.length>=6?<svg fill="none" viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#6C0" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M11.621 6.406l-3.98 4.059c-.266.266-.719.244-1.012-.049-.293-.293-.314-.746-.048-1.012l3.98-4.059c.266-.266.719-.245 1.012.048.293.293.314.747.048 1.013z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M3.803 7.997l2.81 2.532c.267.267.72.245 1.013-.048.293-.293.315-.746.048-1.012l-2.81-2.532c-.267-.267-.72-.245-1.013.048-.293.293-.314.746-.048 1.012z" clip-rule="evenodd"></path></svg>:<svg viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#FF424F" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><rect stroke="none" width="7" height="1.5" x="6.061" y="5" fill="#FF424F" rx=".75" transform="rotate(45 6.06 5)"></rect><rect stroke="none" width="7" height="1.5" fill="#FF424F" rx=".75" transform="scale(-1 1) rotate(45 -11.01 -9.51)"></rect></svg>}    
                                    </div>
                                    <div className={`_3ZGVRW ${formData.password==null?'_2VbYfm':formData.password==''||formData.password.match(/[|\\/~^:,;?!&%$@*+]/)?'_1ilZVp':'_32YsrV'}`}>
                                        ...
                                        {formData.password==null?'':formData.password!==''&&!formData.password.match(/[|\\/~^:,;?!&%$@*+]/)?<svg fill="none" viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#6C0" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M11.621 6.406l-3.98 4.059c-.266.266-.719.244-1.012-.049-.293-.293-.314-.746-.048-1.012l3.98-4.059c.266-.266.719-.245 1.012.048.293.293.314.747.048 1.013z" clip-rule="evenodd"></path><path stroke="none" fill="#6C0" fill-rule="evenodd" d="M3.803 7.997l2.81 2.532c.267.267.72.245 1.013-.048.293-.293.315-.746.048-1.012l-2.81-2.532c-.267-.267-.72-.245-1.013.048-.293.293-.314.746-.048 1.012z" clip-rule="evenodd"></path></svg>:<svg viewBox="0 0 16 16" className="_1svebZ"><path fill="none" stroke="#FF424F" d="M8 15A7 7 0 108 1a7 7 0 000 14z" clip-rule="evenodd"></path><rect stroke="none" width="7" height="1.5" x="6.061" y="5" fill="#FF424F" rx=".75" transform="rotate(45 6.06 5)"></rect><rect stroke="none" width="7" height="1.5" fill="#FF424F" rx=".75" transform="scale(-1 1) rotate(45 -11.01 -9.51)"></rect></svg>}
                                    </div></>
                                    :<>
